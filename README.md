<h1 align="center">Greg's bert-as-service for docker</h1>

See: [BERT as a service](https://github.com/hanxiao/bert-as-service)
...
Extract the files into a directory in `models`. Update the command in `script/up.sh` to match. Currently it's using `uncased_base`.
